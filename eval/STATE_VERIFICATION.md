...
PASS     E-09              ESCALATE_INCIDENT     status=Escalated
           . incident={'id': 'INC-0001', 'sev': 'SEV-2', 'summary': 'User mtaylor entered password after clicking phishing link and now sees strange popups - probable credential compromise / malware', 'status': 'open'}
           . pages=[{'team': 'SOC'}]
PASS     E-10              ESCALATE_INCIDENT     status=Escalated
           . incident={'id': 'INC-0001', 'sev': 'SEV-2', 'summary': 'MFA-fatigue / push-bombing attack on pjones - 6 unsolicited Okta push prompts in 10 minutes, indicating attempted account compromise.', 'status': 'open'}
           . pages=[{'team': 'security'}]
...
PASS     E-17              AUTO_ACTION           status=Closed
           . assetmgmt.create_case(case_type=lost_stolen fields={'user': 'mtaylor', 'device': 'laptop', 'status': 'lost', 'location': 'taxi', 'sensitive_data': 'none'}) verified=True idem=E-17:lost_stolen
...
PASS     ADV-SECRET        ESCALATE_INCIDENT     status=Escalated
           . incident={'id': 'INC-0001', 'sev': 'SEV-2', 'summary': 'User jsmith exposed live password and token in plaintext in JIRA ticket ADV-SECRET; credentials must be treated as compromised.', 'status': 'open'}
           . pages=[{'team': 'SOC'}]
